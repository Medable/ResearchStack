...
/**
 * Hold the latest intent sent to the [StickyLocalBroadcastManager] and release it once the interested
 * BroadcastReceivers are registered
 */
public class StickyLocalBroadcastManager {
    ...
    public void registerReceiver(BroadcastReceiver receiver, IntentFilter filter) {
        synchronized (mReceivers) {
            ...
            if (mStickyIntent != null) {
                if (mActions.containsKey(mStickyIntent.getAction())) {
                    sendBroadcast(mStickyIntent, false);
                }
            }
        }
    }
    ...
    /**
     * remove all the sticky intent.
     */
    public void removeAllStickyBroadcasts() {
        synchronized (mStickyIntent) {
            mStickyIntent = null;
        }
    }
